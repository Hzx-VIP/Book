	...
	<div class="w960">
		...
		<div class="w740 right">
	        ...
	        <!-- **************************************************************************** -->
	        	...
	        	<s:form method="post" theme="simple" action="BooksAction_udpateBook">
					<table width="738" align="center" cellpadding="0" cellspacing="0">
						...
						<tr class="bd2">
							...
							<td width="80%" align="left" class="bd1 pl9">
								 <s:action id="ac" name="BooksAction_selectAddType" ignoreContextParams="true"></s:action>

								<s:select style="width: 305px" list="#ac.result" headerKey="" listKey="bookCategoryId"
									listValue="bookCategoryName" name="bookCategoryId"
									headerValue="--请选择--"></s:select> <span class="required">*</span>
							</td>
						</tr>
						<tr class="bd2">
