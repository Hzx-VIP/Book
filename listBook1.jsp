	...
	<div class="w960">
		...
		<div class="w740 right">
			...
			<div class="order01">
				...
				<s:form action="BooksAction_selectBooks" method="post"
					theme="simple">
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="15%"><input type="image" name="imageField2"
								src="images/btn_cx.png" /></td>
							<td width="15%" align="right"></td>
							<td width="25%"></td>
						</tr>
					</table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<s:iterator value="result" var="v">
						<tr>
							...
							<td width="15%" class="text"><s:property
									value="#v.bookAuthor" /></td>
							<td width="15%" class="text"><s:property
									value="#v.bookPrice" /></td>
							<td width="25%" class="text"><s:property
									value="#v.publishing" /></td>
							<td width="30%" class="text">
							
							<!-- 图片上传 -->
							
							<s:if test="#v.bookImage != 0">
								<s:url id="imageURL" action="UploadAction_doOpen">
								<s:param name="id" value="#v.bookImage"></s:param>
								</s:url>
								<a href="#"><img width="30dp" src='<s:property value="#imageURL"/>'></a>
								
							</s:if>
							<s:else>
								<s:url id="tpURL" action="BooksAction_uploadById">
									<s:param name="bookId" value="bookId"></s:param>
								</s:url> <s:a href="%{#tpURL}">图片上传</s:a>
							</s:else>
							
							<s:url id="updateURL" action="BooksAction_selectByid">
									<s:param name="bookId" value="bookId"></s:param>
								</s:url> 
								
								<s:a href="%{#updateURL}">修改信息</s:a> <s:url id="delURL"
									action="BooksAction_deleteBooks">
									<s:param name="bookId" value="bookId"></s:param>
								</s:url> <s:a href="%{#delURL}">删除</s:a> 
								
								<s:url id="stateURL" action="BooksAction_State">
									<s:param name="bookId" value="bookId"></s:param>
									<s:param name="bookState" value="2"></s:param>
								</s:url> <s:a href="%{#stateURL}">上架</s:a></td>
						</tr>
					</s:iterator>
				</table>
